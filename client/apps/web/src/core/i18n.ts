...
const uz = {
  translation: {
    ...
    home: { compete: "🏆 O'ynash", practice: "📚 O'rganish", assess: "📊 Baholash", rating: "🏅 Reyting", tournament: "🏆 Turnir", admin: "🛠 Admin" },
    lobby: {
      roomCode: "Xona kodi",
    ...
    tournament: {
      empty: "Hozircha turnir yo'q.",
      questions: "{{count}} savol",
      join: "Qatnashish",
      leaderboard: "Reyting",
      noScores: "Hali natija yo'q.",
      noQuestions: "Bu turnirda savol yo'q.",
      progress: "Savol: {{n}} / {{total}}",
      next: "Keyingi",
      result: "Natija",
      percentCorrect: "{{pct}}% to'g'ri",
      back: "Qaytish",
      status: { upcoming: "Tez orada", active: "Faol", finished: "Tugagan" },
    },
  },
};
...
const en = {
  translation: {
    ...
    home: { compete: "🏆 Play", practice: "📚 Learn", assess: "📊 Assess", rating: "🏅 Rating", tournament: "🏆 Tournament", admin: "🛠 Admin" },
    lobby: {
      roomCode: "Room code",
    ...
    tournament: {
      ...
      noQuestions: "No questions in this tournament.",
      progress: "Question: {{n}} / {{total}}",
      next: "Next",
      result: "Result",
      percentCorrect: "{{pct}}% correct",
      back: "Back",
      status: { upcoming: "Upcoming", active: "Active", finished: "Finished" },
    },
  },
};
